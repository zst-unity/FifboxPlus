...
{
    public partial class @FifboxActionsAsset: IInputActionCollection2, IDisposable
    {
        public InputActionAsset asset { get; }
        public @FifboxActionsAsset()
        {
    ...
    ""maps"": [
        ...
        {
            ""name"": ""GameplayUI"",
            ""id"": ""bf7c9fa4-4ac7-4322-b094-3d27d4782ba1"",
            ""actions"": [
                {
                    ""name"": ""ToggleOptions"",
                    ""type"": ""Button"",
                    ""id"": ""094213e4-6467-4d59-8d31-653930b8601c"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""bb1446a1-3673-4e5f-9670-738e5a05a9ac"",
                ...
                {
                    ""name"": """",
                    ""id"": ""83ff9758-febd-4d5d-a6b1-9dc3186a5dfe"",
                    ""path"": ""<Gamepad>/start"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": [
        ...
        },
        {
            ...
            m_GameplayUI_ToggleOptions = m_GameplayUI.FindAction("ToggleOptions", throwIfNotFound: true);
        }

        ~@FifboxActionsAsset()
        {
            Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, FifboxActionsAsset.Player.Disable() has not been called.");
            Debug.Assert(!m_GameplayUI.enabled, "This will cause a leak and performance issues, FifboxActionsAsset.GameplayUI.Disable() has not been called.");
        }
        ...
        {
            private @FifboxActionsAsset m_Wrapper;
            public PlayerActions(@FifboxActionsAsset wrapper) { m_Wrapper = wrapper; }
        ...
        private readonly InputAction m_GameplayUI_ToggleOptions;
        public struct GameplayUIActions
        {
            private @FifboxActionsAsset m_Wrapper;
            public GameplayUIActions(@FifboxActionsAsset wrapper) { m_Wrapper = wrapper; }
            public InputAction @ToggleOptions => m_Wrapper.m_GameplayUI_ToggleOptions;
